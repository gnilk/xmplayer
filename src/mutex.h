/*-------------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------------*/
#ifndef __GOAT_MUTEX_H__
#define __GOAT_MUTEX_H__
...
// Needed??? - only for external binary compatibility
#ifdef WIN32
#define GOAT_NOVTBL DECLSPEC_NOVTABLE
#else
#define GOAT_NOVTBL 
#endif
